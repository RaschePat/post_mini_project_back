...
//    private final UserMapper userMapper;
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        PrincipalUser principalUser = new PrincipalUser(foundUser);     // principal: 인증된 사용자 정보
        String password = "";                   // credentials: 비밀번호 (필요없음)
        Collection<? extends GrantedAuthority> authorities = principalUser.getAuthorities();  // authorities: 권한 목록
